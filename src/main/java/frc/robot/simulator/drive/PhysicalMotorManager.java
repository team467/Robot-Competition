...
//    motor.setOutputByDemandType(demand0, demand1Type, demand1);
 ...
 static void selectDemandType(long handle, DemandType demandType) {
   ...
   */
  static int configFactoryDefault(double handle, int timeoutMs){
    // TODO: Look up and set all factory defaults
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
 ...
 static int configOpenLoopRamp(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configClosedLoopRamp(long handle, double secondsFromNeutralToFull, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configPeakOutputForward(long handle, double percentOut, int timeoutMs) {
    // TODO peak output forward
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configPeakOutputReverse(long handle, double percentOut, int timeoutMs) {
    // TODO: peak output reverse
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configNominalOutputForward(long handle, double percentOut, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configNominalOutputReverse(long handle, double percentOut, int timeoutMs) {
    // TODO: config nominal output reverse
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configNeutralDeadband(long handle, double percentDeadband, int timeoutMs) {
    // TODO: neutral deadband
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int configVoltageCompSaturation(long handle, double voltage, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configVoltageMeasurementFilter(
 ...
 static void enableVoltageCompensation(long handle, boolean enable) {
  ...
  static double getMotorOutputPercent(long handle) {
    // TODO: return motor output percent
    return 0.0;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configSelectedFeedbackSensor(
      long handle, int feedbackDeviceValue, int pidIdx, int timeoutMs) {
    PhysicalMotorManager motor = motors.get(handle);
    // int retval = MotControllerJNI.ConfigSelectedFeedbackSensor(
    // m_handle, feedbackDevice.value, pidIdx, timeoutMs);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configSelectedFeedbackCoefficient(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configRemoteFeedbackFilter(
 ...
 static int configSensorTerm(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int setSelectedSensorPosition(long handle, int sensorPos, int pidIdx, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int setControlFramePeriod(long handle, int frame, int periodMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int setStatusFramePeriod(long handle, int frameValue, int periodMs, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configVelocityMeasurementPeriod(
      long handle, int velocityMeasurementPeriod, int timeoutMs) {
    // int retval = MotControllerJNI.ConfigVelocityMeasurementPeriod(m_handle, period.value, timeoutMs);
    // TODO: Figure out velocity measure window smooting
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configVelocityMeasurementWindow(long handle, int windowSize, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int configReverseLimitSwitchSource(
      long handle, int remoteLimitSwitchSourceTypeValue, int limitSwitchNormalOpenOrCloseValue,
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int configForwardLimitSwitchSource(
      long handle, int remoteLimitSwitchSourceTypeValue, int limitSwitchNormalOpenOrCloseValue,
      int deviceId, int timeoutMs) {
    // int retval = MotControllerJNI.ConfigForwardLimitSwitchSource(
    //   m_handle, typeValue, normalOpenOrCloseValue, deviceID, timeoutMs);
    // TODO: Figure out limit switches
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
 ...
 static void overrideLimitSwitchesEnable(long handle, boolean enable) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configForwardSoftLimitThreshold(long handle, int forwardSensorLimit, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configReverseSoftLimitThreshold(long handle, int reverseSensorLimit, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configForwardSoftLimitEnable(long handle, boolean enable, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configReverseSoftLimitEnable(long handle, boolean enable, int timeoutMs) {
 ...
 static void overrideSoftLimitsEnable(long handle, boolean enable) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int config_kP(long handle, int slotIdx, double value, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int config_kI(long handle, int slotIdx, double value, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int config_kD(long handle, int slotIdx, double value, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int config_kF(long handle, int slotIdx, double value, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int config_IntegralZone(long handle, int slotIdx, int izone, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configAllowableClosedloopError(
      long handle, int slotIdx, int allowableClosedLoopError, int timeoutMs) {
    // int retval = MotControllerJNI.ConfigAllowableClosedloopError(
    // m_handle, slotIdx, allowableClosedLoopError, timeoutMs);
    // TODO: Figure out PID Loops
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int configMaxIntegralAccumulator(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configClosedLoopPeakOutput(long handle, int slotIdx, double percentOut, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int configClosedLoopPeriod(long handle, int slotIdx, int loopTimeMs, int timeoutMs) {
    // TODO: Figure out PID Loops
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int setIntegralAccumulator(
 ...
 static void selectProfileSlot(long handle, int slotIdx, int pidIdx) {
    ...
    //TODO: Create PID Slots
  }
  private int[] currentClosedLoopTarget = new int[2];
  ...
  static int getClosedLoopTarget(long handle, int pidIdx) {
    return motors.get(handle).currentClosedLoopTarget[pidIdx];
    // TODO: Check range
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configMotionCruiseVelocity(long handle, int sensorUnitsPer100ms, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configMotionAcceleration(long handle, int sensorUnitsPer100msPerSec, int timeoutMs) {
    // TODO: Figure out Motion Magic Stuff
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * API (top).
   */
 static int clearMotionProfileTrajectories(long handle) {
    // TODO: Figure out Motion Magic Stuff
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   */
  static int pushMotionProfileTrajectory2(
      long handle,
   ...
   */
  static int getMotionProfileStatus2(long handle, int[] motionProfileStatistics) {
    // TODO: Figure out Motion Magic Stuff
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int clearMotionProfileHasUnderrun(long handle, int timeoutMs) {
    // TODO: Figure out Motion Magic Stuff
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int changeMotionControlFramePeriod(long handle, int periodMs) {
    // TODO: Figure out Motion Magic Stuff
    PhysicalMotorManager motor = motors.get(handle);
    return motor.lastError.value;
  }
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configMotionProfileTrajectoryPeriod(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configFeedbackNotContinuous(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configRemoteSensorClosedLoopDisableNeutralOnLOS(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int configClearPositionOnLimitF(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int configClearPositionOnLimitR(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configClearPositionOnQuadIdx(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int configLimitSwitchDisableNeutralOnLOS(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
  static int configSoftLimitDisableNeutralOnLOS(
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configPulseWidthPeriod_EdgesPerRot(long handle,
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configPulseWidthPeriod_FilterWindowSz(long handle,
   ...
   */
 static int getLastError(long handle) {
  PhysicalMotorManager motor = motors.get(handle);
  return motor.lastError.value;
}
   ...
   * @return Last Error Code generated by a function.
   */
 static int clearStickyFaults(long handle, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configSetCustomParam(long handle, int newValue, int paramIndex, int timeoutMs) {
   ...
   * @return Error Code generated by function. 0 indicates no error.
   */
 static int configSetParameter(long handle, int param, double value,
...
/**
   ...
   *            blocking or checking is performed.
   */
  static int configPeakCurrentLimit(long handle, int amps, int timeoutMs) {
    PhysicalMotorManager motor = motors.get(handle);
   ...
   *            blocking or checking is performed.
   */
  static int configPeakCurrentDuration(long handle, int milliseconds, int timeoutMs) {
    PhysicalMotorManager motor = motors.get(handle);
   ...
   *            blocking or checking is performed.
   */
  static int configContinuousCurrentLimit(long handle, int amps, int timeoutMs) {
    PhysicalMotorManager motor = motors.get(handle);
