...
public abstract class BaseMotorController implements com.ctre.phoenix.motorcontrol.IMotorController {
  ...
  public ErrorCode configFactoryDefault(int timeoutMs){
    int retval = PhysicalMotorManager.configFactoryDefault(m_handle, timeoutMs);
  ...
  public ErrorCode configOpenloopRamp(double secondsFromNeutralToFull, int timeoutMs) {
    int retval = PhysicalMotorManager.configOpenLoopRamp(m_handle, secondsFromNeutralToFull, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configClosedloopRamp(double secondsFromNeutralToFull, int timeoutMs) {
    int retval = PhysicalMotorManager.configClosedLoopRamp(m_handle, secondsFromNeutralToFull, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configPeakOutputForward(double percentOut, int timeoutMs) {
    int retval = PhysicalMotorManager.configPeakOutputForward(m_handle, percentOut, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configPeakOutputReverse(double percentOut, int timeoutMs) {
    int retval = PhysicalMotorManager.configPeakOutputReverse(m_handle, percentOut, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configNominalOutputForward(double percentOut, int timeoutMs) {
    int retval = PhysicalMotorManager.configNominalOutputForward(m_handle, percentOut, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configNominalOutputReverse(double percentOut, int timeoutMs) {
    int retval = PhysicalMotorManager.configNominalOutputReverse(m_handle, percentOut, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configNeutralDeadband(double percentDeadband, int timeoutMs) {
    int retval = PhysicalMotorManager.configNeutralDeadband(m_handle, percentDeadband, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configVoltageCompSaturation(double voltage, int timeoutMs) {
    int retval = PhysicalMotorManager.configVoltageCompSaturation(m_handle, voltage, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configVoltageMeasurementFilter(int filterWindowSamples, int timeoutMs) {
    int retval = PhysicalMotorManager.configVoltageMeasurementFilter(m_handle, filterWindowSamples, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configSelectedFeedbackSensor(RemoteFeedbackDevice feedbackDevice, int pidIdx, int timeoutMs) {
    int retval = PhysicalMotorManager.configSelectedFeedbackSensor(m_handle, feedbackDevice.value, pidIdx, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configSelectedFeedbackCoefficient(double coefficient, int pidIdx, int timeoutMs) {
    int retval = PhysicalMotorManager.configSelectedFeedbackCoefficient(m_handle, coefficient, pidIdx, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configRemoteFeedbackFilter(int deviceID, RemoteSensorSource remoteSensorSource, int remoteOrdinal,
      int timeoutMs) {
    int retval = PhysicalMotorManager.configRemoteFeedbackFilter(m_handle, deviceID, remoteSensorSource.value, remoteOrdinal,
        timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  public ErrorCode configRemoteFeedbackFilter(int deviceID, RemoteSensorSource remoteSensorSource, int remoteOrdinal) {
  ...
  public ErrorCode configSensorTerm(SensorTerm sensorTerm, FeedbackDevice feedbackDevice, int timeoutMs) {
    int retval = PhysicalMotorManager.configSensorTerm(m_handle, sensorTerm.value, feedbackDevice.value, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode setSelectedSensorPosition(int sensorPos, int pidIdx, int timeoutMs) {
    int retval = PhysicalMotorManager.setSelectedSensorPosition(m_handle, sensorPos, pidIdx, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode setControlFramePeriod(ControlFrame frame, int periodMs) {
    int retval = PhysicalMotorManager.setControlFramePeriod(m_handle, frame.value, periodMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode setControlFramePeriod(int frame, int periodMs) {
    int retval = PhysicalMotorManager.setControlFramePeriod(m_handle, frame, periodMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode setStatusFramePeriod(int frameValue, int periodMs, int timeoutMs) {
    int retval = PhysicalMotorManager.setStatusFramePeriod(m_handle, frameValue, periodMs, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configVelocityMeasurementPeriod(VelocityMeasPeriod period, int timeoutMs) {
    int retval = PhysicalMotorManager.configVelocityMeasurementPeriod(m_handle, period.value, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configVelocityMeasurementWindow(int windowSize, int timeoutMs) {
    int retval = PhysicalMotorManager.configVelocityMeasurementWindow(m_handle, windowSize, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configReverseLimitSwitchSource(RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose,
      int deviceID, int timeoutMs) {
    int retval = PhysicalMotorManager.configReverseLimitSwitchSource(m_handle, type.value, normalOpenOrClose.value,
        deviceID, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  public ErrorCode configReverseLimitSwitchSource(RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose,
  ...
  protected ErrorCode configForwardLimitSwitchSource(int typeValue, int normalOpenOrCloseValue, int deviceID,
      int timeoutMs) {
    int retval = PhysicalMotorManager.configForwardLimitSwitchSource(m_handle, typeValue, normalOpenOrCloseValue,
        deviceID, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  protected ErrorCode configReverseLimitSwitchSource(int typeValue, int normalOpenOrCloseValue, int deviceID,
      int timeoutMs) {
    int retval = PhysicalMotorManager.configReverseLimitSwitchSource(m_handle, typeValue, normalOpenOrCloseValue,
        deviceID, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configForwardSoftLimitThreshold(int forwardSensorLimit, int timeoutMs) {
    int retval = PhysicalMotorManager.configForwardSoftLimitThreshold(m_handle, forwardSensorLimit, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configReverseSoftLimitThreshold(int reverseSensorLimit, int timeoutMs) {
    int retval = PhysicalMotorManager.configReverseSoftLimitThreshold(m_handle, reverseSensorLimit, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configForwardSoftLimitEnable(boolean enable, int timeoutMs) {
    int retval = PhysicalMotorManager.configForwardSoftLimitEnable(m_handle, enable, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configReverseSoftLimitEnable(boolean enable, int timeoutMs) {
    int retval = PhysicalMotorManager.configReverseSoftLimitEnable(m_handle, enable, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode config_kP(int slotIdx, double value, int timeoutMs) {
    int retval = PhysicalMotorManager.config_kP(m_handle, slotIdx,  value, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode config_kI(int slotIdx, double value, int timeoutMs) {
    int retval = PhysicalMotorManager.config_kI(m_handle, slotIdx,  value, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode config_kD(int slotIdx, double value, int timeoutMs) {
    int retval = PhysicalMotorManager.config_kD(m_handle, slotIdx,  value, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode config_kF(int slotIdx, double value, int timeoutMs) {
    int retval = PhysicalMotorManager.config_kF(m_handle, slotIdx,  value, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode config_IntegralZone(int slotIdx, int izone, int timeoutMs) {
    int retval = PhysicalMotorManager.config_IntegralZone(m_handle, slotIdx,  izone, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configAllowableClosedloopError(int slotIdx, int allowableClosedLoopError, int timeoutMs) {
    int retval = PhysicalMotorManager.configAllowableClosedloopError(m_handle, slotIdx, allowableClosedLoopError,
        timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configMaxIntegralAccumulator(int slotIdx, double iaccum, int timeoutMs) {
    int retval = PhysicalMotorManager.configMaxIntegralAccumulator(m_handle, slotIdx, iaccum, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configClosedLoopPeakOutput(int slotIdx, double percentOut, int timeoutMs) {
    int retval = PhysicalMotorManager.configClosedLoopPeakOutput(m_handle, slotIdx, percentOut, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
   ...
   */
    ...
    int retval = PhysicalMotorManager.configClosedLoopPeriod(m_handle, slotIdx, loopTimeMs, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode setIntegralAccumulator(double iaccum, int pidIdx, int timeoutMs) {
    int retval = PhysicalMotorManager.setIntegralAccumulator(m_handle,  iaccum, pidIdx, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configMotionCruiseVelocity(int sensorUnitsPer100ms, int timeoutMs) {
    int retval = PhysicalMotorManager.configMotionCruiseVelocity(m_handle, sensorUnitsPer100ms, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configMotionAcceleration(int sensorUnitsPer100msPerSec, int timeoutMs) {
    int retval = PhysicalMotorManager.configMotionAcceleration(m_handle, sensorUnitsPer100msPerSec, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode clearMotionProfileTrajectories() {
    int retval = PhysicalMotorManager.clearMotionProfileTrajectories(m_handle);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode pushMotionProfileTrajectory(TrajectoryPoint trajPt) {
    int retval = PhysicalMotorManager.pushMotionProfileTrajectory2(m_handle,
  ...
  public ErrorCode getMotionProfileStatus(MotionProfileStatus statusToFill) {
    int retval = PhysicalMotorManager.getMotionProfileStatus2(m_handle, _motionProfStats);
  ...
  public ErrorCode clearMotionProfileHasUnderrun(int timeoutMs) {
    int retval = PhysicalMotorManager.clearMotionProfileHasUnderrun(m_handle, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode changeMotionControlFramePeriod(int periodMs) {
    int retval = PhysicalMotorManager.changeMotionControlFramePeriod(m_handle, periodMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configMotionProfileTrajectoryPeriod(int baseTrajDurationMs, int timeoutMs) {
    int retval = PhysicalMotorManager.configMotionProfileTrajectoryPeriod(m_handle, baseTrajDurationMs, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  public ErrorCode configMotionProfileTrajectoryPeriod(int baseTrajDurationMs) {
    ...
    public ErrorCode configFeedbackNotContinuous(boolean feedbackNotContinuous, int timeoutMs) {
        int retval = PhysicalMotorManager.configFeedbackNotContinuous(m_handle, feedbackNotContinuous, timeoutMs);
        return ErrorCode.valueOf(retval);
    }
    ...
    public ErrorCode configRemoteSensorClosedLoopDisableNeutralOnLOS(
      ...
      int retval = PhysicalMotorManager.configRemoteSensorClosedLoopDisableNeutralOnLOS(
    ...
    public ErrorCode configClearPositionOnLimitF(boolean clearPositionOnLimitF, int timeoutMs) {
        int retval = PhysicalMotorManager.configClearPositionOnLimitF(m_handle, clearPositionOnLimitF, timeoutMs);
        return ErrorCode.valueOf(retval);
    }
    ...
    public ErrorCode configClearPositionOnLimitR(boolean clearPositionOnLimitR, int timeoutMs) {
        int retval = PhysicalMotorManager.configClearPositionOnLimitR(m_handle, clearPositionOnLimitR, timeoutMs);
        return ErrorCode.valueOf(retval);
    }
    ...
    public ErrorCode configClearPositionOnQuadIdx(boolean clearPositionOnQuadIdx, int timeoutMs) {
        int retval = PhysicalMotorManager.configClearPositionOnQuadIdx(m_handle, clearPositionOnQuadIdx, timeoutMs);
        return ErrorCode.valueOf(retval);
    }
    ...
    public ErrorCode configLimitSwitchDisableNeutralOnLOS(boolean limitSwitchDisableNeutralOnLOS, int timeoutMs) {
        int retval = PhysicalMotorManager.configLimitSwitchDisableNeutralOnLOS(
    ...
    public ErrorCode configSoftLimitDisableNeutralOnLOS(boolean softLimitDisableNeutralOnLOS, int timeoutMs) {
        int retval = PhysicalMotorManager.configSoftLimitDisableNeutralOnLOS(
    ...
    public ErrorCode configPulseWidthPeriod_EdgesPerRot(int pulseWidthPeriod_EdgesPerRot, int timeoutMs) {
        int retval = PhysicalMotorManager.configPulseWidthPeriod_EdgesPerRot(m_handle, pulseWidthPeriod_EdgesPerRot, timeoutMs);
        return ErrorCode.valueOf(retval);
    }
    ...
    public ErrorCode configPulseWidthPeriod_FilterWindowSz(int pulseWidthPeriod_FilterWindowSz, int timeoutMs) {
        int retval = PhysicalMotorManager.configPulseWidthPeriod_FilterWindowSz(m_handle, pulseWidthPeriod_FilterWindowSz, timeoutMs);
        return ErrorCode.valueOf(retval);
    }
  // ------ error ----------//
  /**
  ...
  public ErrorCode getLastError() {
    int retval = PhysicalMotorManager.getLastError(m_handle);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode clearStickyFaults(int timeoutMs) {
    int retval = PhysicalMotorManager.clearStickyFaults(m_handle, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public ErrorCode configSetCustomParam(int newValue, int paramIndex, int timeoutMs) {
    int retval = PhysicalMotorManager.configSetCustomParam(m_handle, newValue, paramIndex, timeoutMs);
    return ErrorCode.valueOf(retval);
  }
  ...
  public int configGetCustomParam(int paramIndex, int timeoutMs) {
    int retval = PhysicalMotorManager.configGetCustomParam(m_handle, paramIndex, timeoutMs);
    return retval;
  }
  ...
  public ErrorCode configSetParameter(int param, double value, int subValue, int ordinal, int timeoutMs) {
    int retval = PhysicalMotorManager.configSetParameter(m_handle, param,  value, subValue, ordinal,
        timeoutMs);
    return ErrorCode.valueOf(retval);
  }
