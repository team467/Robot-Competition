...
//		_sensorColl = new SensorCollection(this);
	...
	public void enableCurrentLimit(boolean enable) {
		PhysicalMotorManager.enableCurrentLimit(m_handle, enable);
	}
	...
	public ErrorCode configAllSettings(TalonSRXConfiguration allConfigs, int timeoutMs) {
        ...
        //------ limit switch ----------//   
        errorCollection.NewError(PhysicalMotorManager.configForwardLimitSwitchSource(m_handle, allConfigs.forwardLimitSwitchSource.value,
                allConfigs.forwardLimitSwitchNormal.value, allConfigs.forwardLimitSwitchDeviceID, timeoutMs));
        errorCollection.NewError(PhysicalMotorManager.configReverseLimitSwitchSource(m_handle, allConfigs.reverseLimitSwitchSource.value,
