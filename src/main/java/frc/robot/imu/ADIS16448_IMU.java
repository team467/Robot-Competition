...
public class ADIS16448_IMU extends GyroBase implements Gyro, PIDSource, IMU {
  ...
  private final Lock samplesMutex;
  private final Condition samplesNotEmpty;
  private int samplesCount = 0;
  private int samplesTakeIndex = 0;
  private int samplesPutIndex = 0;
  private boolean calculateStarted = false;
   ...
   * Constructor.
   */
  public ADIS16448_IMU(Axis yawAxis, AHRSAlgorithm algorithm) {
    ...
    samples = new Sample[kSamplesDepth + 2];
   ...
   */
  public ADIS16448_IMU(Axis yawAxis) {
    this(yawAxis, AHRSAlgorithm.kComplementary);
  }
  ...
  private void acquire() {
    ...
    while (!m_freed.get()) {
      ...
      try {
        ...
        if (calculateStarted && samplesCount < kSamplesDepth) {
