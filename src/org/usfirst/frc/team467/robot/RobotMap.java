...
public class RobotMap {
	...
	public static void init(RobotID id) {
		...
		case Competition_2:
			...
			LEFT_FOLLOWER_1_CHANNEL = 2;
			LEFT_FOLLOWER_2_CHANNEL = 3;
			LEFT_DRIVE_PID_P = 1.3;
			LEFT_DRIVE_PID_I = 0.65;
			LEFT_DRIVE_PID_D = 600.0;
			LEFT_DRIVE_PID_F = 150.0;

			RIGHT_LEAD_CHANNEL = 4;
			RIGHT_FOLLOWER_1_CHANNEL = 5;
			RIGHT_FOLLOWER_2_CHANNEL = 6;
			RIGHT_DRIVE_PID_P = 1.22;
			RIGHT_DRIVE_PID_I = 0.61;
			RIGHT_DRIVE_PID_D = 675.0;
			RIGHT_DRIVE_PID_F = 120.0;
